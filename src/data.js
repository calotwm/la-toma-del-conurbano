...
export const TERR = [
  ...
  // ZONA NORTE
  { id:'escobar',     name:'Escobar',         x:350, y:40,  r:18, zone:'norte', flavor:'Fincas, countries y el Río Luján: la frontera verde del norte.' },
  { id:'pilar',       name:'Pilar',           x:195, y:60,  r:18, zone:'norte', flavor:'Countries a lo loco y la Panamericana como arteria: la city boom del norte.' },
  ...
  { id:'exaltacion',  name:'Exaltación de la Cruz', x:255, y:25, r:18, zone:'norte', flavor:'Campo abierto y countries en obra: el norte que todavía no terminó de construirse.' },
  ...
  { id:'lujan',       name:'Luján',           x:32,  y:435, r:18, zone:'oeste', flavor:'La Basílica y el turismo religioso: acá se reza antes de atacar.' },
...
export const ADJ_PAIRS = [
  ...
  ['ezeiza','lamatanza'],['ezeiza','echeverria'],['ezeiza','brown'],['ezeiza','presidenteperon'],
