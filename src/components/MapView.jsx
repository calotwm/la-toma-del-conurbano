        ...
        {TERR.map(t => {
          ...
          return (
            <g key={t.id}
              ...
              {/* anillo de zona: marca la delimitación por color de forma limpia */}
              {!t.special && <circle cx={t.x} cy={t.y} r={r + 4} fill="none" stroke={ZONES[t.zone]?.color || '#55637f'} strokeWidth="1" opacity="0.55"/>}
