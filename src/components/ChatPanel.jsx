...
// Componente sin red propia: recibe los mensajes ya armados y un onSend, así sirve
// tanto para el chat online (socket) como para el chat local (estado en memoria).
...
export default function ChatPanel({ chat, myId, onSend, zone, setZone }) {
  ...
  const curZone = CHAT_ZONES.find(z => z.key === zone);
